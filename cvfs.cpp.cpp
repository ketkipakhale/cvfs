...
void man(char *name)
{
    ...
    {
        printf("Description : Used to display information of file\n");
        printf("Usage : stat File_Decriptor\n");
    ...
    {
        printf("Description : Used to deete the file\n");
...
void DisplayHelp()
{
    ...
    printf("closeall :To closeall files\n");
...
int fstat_file(int fd)
{
    ...
    printf("\n-------------Stastical Information about file------------\n");
    printf("File name :%s\n",temp->FileName);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Termminating the Marvellous Virtual File System\n ");
                break;
            }
            else{
